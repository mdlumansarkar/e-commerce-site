...
//               <h1 className="text-warning mb-0 me-2">Sotero</h1>
//               <h3 className="text-muted mb-0">Online Shopping</h3>
//             </NavLink>
...
//                 </li>
//                 <li className="nav-item">
//                   <NavLink className="nav-link my-2 mx-2" to="/">Product Store</NavLink>
//                 </li>
//                 <li className="nav-item">
//                   <NavLink className="nav-link my-2 mx-2" to="/create">Create</NavLink>
//                 </li>
//                 <li className="nav-item">
//                   <button className="btn btn-outline-primary btn-sm mx-2">Add Item</button>
//                 </li>
//                 <li className="nav-item">
//                   <button className="btn btn-outline-dark btn-sm mx-2">Dark Mode</button>
//                 </li>
